    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for RandomnessReceived {
            const NAME: &'static str = "RandomnessReceived";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for RandomnessRequested {
            const NAME: &'static str = "RandomnessRequested";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
